"""
Django settings for solana_portfolio_tracker project.
...
ALLOWED_HOSTS = ["0.0.0.0", "127.0.0.1", "seashell-app-aq7tp.ondigitalocean.app", 'trackoff.app']
...
ROOT_URLCONF = 'solana_portfolio_tracker.urls'
...
WSGI_APPLICATION = 'solana_portfolio_tracker.wsgi.application'
...
CSRF_TRUSTED_ORIGINS = ['https://seashell-app-aq7tp.ondigitalocean.app', 'trackoff.app']
